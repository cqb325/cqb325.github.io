define(["module", "react", "react-dom", "../BaseDemo", "Accordion", "Button", "FontIcon", "../Code"], function (module, React, ReactDOM, BaseDemo, Accordion, Button, FontIcon, Code) {
    "use strict";
            ...
            value: function render() {
                return React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            Accordion,
                            { style: { width: '500px' }, ref: "accordion", theme: "white" },
                            React.createElement(
                                Accordion.Item,
                            ...
                            React.createElement(
                                Accordion.Item,
                                { identify: "sdk", title: "整合的移动SDK", icon: "th" },
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                Button,
                                { onClick: this.activeByIndex.bind(this) },
                                "打开第2项"
                            ),
                            React.createElement(
                                Button,
                                { className: "ml-10", onClick: this.activeItem.bind(this) },
                                "根据key打开"
                            )
                        )
                    ),
