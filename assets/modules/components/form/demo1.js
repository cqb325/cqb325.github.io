                ...
                return React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(FormControl, { type: "text", label: "Input" }),
                            React.createElement(FormControl, { type: "select", label: "Select", data: ["Option1", "Option2"] }),
                            React.createElement(FormControl, { type: "datetime", label: "DateTime", dateOnly: true }),
                            React.createElement(FormControl, { type: "daterange", label: "DateRange", maxRange: 30 }),
                            React.createElement(FormControl, { type: "checkbox", label: "checkbox", data: [{ id: "0", text: "check1" }, { id: "1", text: "check2" }] }),
                            React.createElement(FormControl, { type: "radio", stick: true, label: "Radio", data: [{ id: "0", text: "radio1" }, { id: "1", text: "radio2" }] }),
                            React.createElement(FormControl, { type: "file", label: "Upload" }),
                            React.createElement(FormControl, { type: "textarea", label: "TextArea", height: "50" })
                        )
                    ),
                    React.createElement(
                        "div",
